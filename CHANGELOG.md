...
- **iCodev branding.** The interface uses Agent District and iCodev Tecnologia e Inovação. The footer links to icodev.com.br; the example advertisement uses `icodev.tech`.
